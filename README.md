...
Released versions are tagged to match (e.g. `v1.6.0`), the latest release will be tagged `latest`, and a `master` tag is also available with the freshest development build.
